...
// Yahan apna sahi WhatsApp number set kar diya gaya hai
...
function rotate3DStageEngine(activeIndex) {
    ...
    if (submitBtn) {
        submitBtn.style.background = currentProduct.color;
    }
...
// Slider speed (Aap yahan 4000 matlab 4 seconds set kar sakte hain taaki yeh dheere chale)
